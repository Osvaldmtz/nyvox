    ...
    >
      <article>
        <div className="relative aspect-[3/2] overflow-hidden bg-nyvox-cream">
          ...
          <span className="pointer-events-none absolute bottom-6 right-6 text-sm font-medium tracking-tight text-white opacity-0 drop-shadow-md transition-opacity duration-300 group-hover:opacity-100">
            Ver caso →
          </span>
        </div>
